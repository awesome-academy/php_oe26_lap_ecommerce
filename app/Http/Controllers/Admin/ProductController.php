...
class ProductController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        $categories = $this->categoryRepository->getSubCategories(config('admin.zero'), config('admin.max_category'));
        $images = $this->imageRepository->getImageByProduct($product->id);
