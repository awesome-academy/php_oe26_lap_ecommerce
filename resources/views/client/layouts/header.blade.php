                        ...
                        <div class="jtv-lang-cur-wrapper">
                            <div class="jtv-inner-box">
                                <div class="block jtv-language-block">
                                    <div class="lg-cur">
                                        <span>
                                            <img src="{{ asset('storage/images/vietnam.png') }}" alt="@lang('header.vn')">
                                    ...
                                    <ul>
                                        <li>
                                            <a href="#"><img src="{{ asset('storage/images/english.png') }}" alt="@lang('header.en')">
                                                <span>@lang('header.en')</span></a>
                                        </li>
                                        <li>
                                            <a href="#"><img src="{{ asset('storage/images/vietnam.png') }}" alt="@lang('header.vn')">
                                                <span>@lang('header.vn')</span></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <ul class="links">
                            <li>
                                <a title="@lang('header.sin')" href="#">
                                    <span class="hidden-xs">@lang('header.sin')</span></a>
                            </li>
                        </ul>
                    </div>
                </div>
